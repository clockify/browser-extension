                ...
                <div className="poppup-modal">
                    <div className="poppup-modal__title-and-close">
                        ...
                        <span onClick={this.cancel.bind(this)}
                                className="poppup-modal__close"></span>
                    </div>
                    <div className="poppup-modal--divider"></div>
                    <p className="poppup-modal--text">{this.props.workspaceName} {locales.WORKSPACE__TWO_FACTOR__MODAL__INFO_MESSAGE}</p>
                    <div onClick={this.openSettings.bind(this)}
                            className="poppup-modal--confirmation_button">{locales.WORKSPACE__TWO_FACTOR__MODAL__ENABLE}</div>
                </div>
            </div>
        );
    }
