(function(){
    ...
    function getClientName() {
        if ($('#client-editor .has-selected .px-select-label') != null) {
            ...
            return $('.c-header--context__section--client .client-name p').textContent.trim();
        } else {
            // client page
            return $('.c-header .o-media .o-media__body .c-heading-3').textContent.trim()
        }
    }
    ...
    function insertButton(button) {
        ...
        button.classList.add('c-button','c-button--outline','c-button--neutral','c-button--small','u-mr-small');
